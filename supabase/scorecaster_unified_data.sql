...
revoke insert, update, delete on public.unified_data_snapshots from authenticated;
revoke insert, update, delete on public.unified_data_provider_observations from authenticated;
revoke insert, update, delete on public.unified_data_closing_records from authenticated;
revoke insert, update, delete on public.unified_data_incidents from authenticated;
