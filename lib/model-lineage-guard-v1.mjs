...
const HISTORICAL_PATTERNS = [/historical/, /result/, /form/, /rating/, /elo/, /rest/, /schedule/];
const EXPECTED_PATTERNS = [/expected/, /\bxg\b/, /shot-quality/, /efficiency/, /epa/, /xwoba/, /strokes-gained/, /expected-points/];
const TRACKING_PATTERNS = [/tracking/, /location/, /trajectory/, /speed/, /distance/, /spacing/];
const STAT_PATTERNS = [/event-stat/, /box-score/, /team-stat/, /player-stat/, /possession/, /shot/, /attempt/, /pace/, /offensive-rating/, /defensive-rating/];
