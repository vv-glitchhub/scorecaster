...
function normalizePairedEvidence(pairedEvidence = {}) {
  ...
  const evidenceRef = safeEvidenceRef(pairedEvidence.evidenceRef);
  ...
  if (!evidenceRef) errors.push("missing-paired-evidence-reference");
  ...
  for (const raw of candidates) {
    ...
    const rebuilt = buildTransparent1X2ModelCandidate({
      ...
      pairedEvidence: {
        ...
        evidenceRef: raw?.pairedEvidence?.evidenceRef,
