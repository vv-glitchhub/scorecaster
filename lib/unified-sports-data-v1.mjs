...
import { calculatePregameEvidenceCoverage } from "./pregame-evidence-coverage-v1.mjs";
...
export function buildUnifiedSportsDataLedger({ pick = {}, sportsReport = {}, secondaryOdds = null, context = null, weather = null, now = Date.now() } = {}) {
  ...
  const pregameCoverage = calculatePregameEvidenceCoverage(factors);
  ...
  return {
    ...
    coverage: {
      ...
      verifiedCoverageRate: pregameCoverage.applicableVerifiedCoverageRate,
      pregameCoverageRate: pregameCoverage.applicableCoverageRate,
      applicablePregameFamilies: pregameCoverage.applicablePregameFamilies,
      configuredPregameFamilies: pregameCoverage.configuredPregameFamilies,
      usedPregameFamilies: pregameCoverage.usedPregameFamilies,
      verifiedPregameFamilies: pregameCoverage.verifiedPregameFamilies,
      pregameCoverageVersion: pregameCoverage.version,
      pregameExcludedFamilies: pregameCoverage.excludedFamilies,
      syntheticZeroRestRejected: pregameCoverage.syntheticZeroRestRejected,
