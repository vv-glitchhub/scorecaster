...
function normalizeLineups(section, match, now) {
  ...
  for (const row of rows) {
    ...
    const keyPlayersAvailable = row?.keyPlayersAvailable !== false;
    ...
    if (!keyPlayersAvailable) impact -= 0.025;
