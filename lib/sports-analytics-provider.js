...
function matchPayload(match = {}) {
  ...
  return {
    contract: "scorecaster-sports-analytics-v1",
    event: {
    ...
    requestedMetrics: Object.values(definition?.families || {}).flat().slice(0, 300),
    policy: {
...
export async function fetchExternalSportsAnalytics(match = {}, { capturedAt = new Date().toISOString() } = {}) {
  ...
  const headers = {
    ...
    "User-Agent": "Scorecaster-Sports-Analytics/1.0"
  };
