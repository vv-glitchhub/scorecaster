...
const fingerprintPrefix = (value) => createHash("sha256").update(String(value || "")).digest("hex").slice(0, 12);
...
export function assessAgentDecisionSigningKey(key, { now = Date.parse("2026-08-08T00:00:00.000Z") } = {}) {
  ...
  return {
    ...
    recommendedGeneratedBytes: AGENT_SIGNING_KEY_GENERATED_BYTES,
    fingerprintPrefix: configured ? fingerprintPrefix(value) : null,
    roundTripPassed,
    wrongKeyRejected,
