...
export function buildMatchXRay(input = {}) {
  ...
  const missingInputs = [
    home.rating === null ? "home.rating" : null,
    home.attack === null ? "home.attack" : null,
    home.defense === null ? "home.defense" : null,
    home.adjustedForm === null ? "home.form" : null,
    away.rating === null ? "away.rating" : null,
    away.attack === null ? "away.attack" : null,
    away.defense === null ? "away.defense" : null,
    away.adjustedForm === null ? "away.form" : null
  ].filter(Boolean);
  ...
  if (missingInputs.length) {
    return { ok: false, xrayVersion: MATCH_XRAY_VERSION, reason: "missing-required-inputs", missingInputs, paperOnly: true };
  }
