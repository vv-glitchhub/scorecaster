...
import { buildUncertaintyEngineV1 } from "./uncertainty-engine-v1.mjs";
...
export function attachDecisionArchitectureV1(pick = {}, { now = Date.now() } = {}) {
  ...
  const uncertaintyEngine = buildUncertaintyEngineV1(pick, {
    featureEngine,
    modelFactory,
    ensembleEngine,
    now
  ...
  return {
    ...
    uncertaintyEngineV1: uncertaintyEngine,
    decisionArchitectureV1: {
      ...
      uncertaintyEngineVersion: uncertaintyEngine.version,
      uncertaintyIndex: uncertaintyEngine.uncertaintyIndex,
      evidenceReadiness: uncertaintyEngine.evidenceReadiness,
      uncertaintyBand: uncertaintyEngine.band,
      uncertaintyResearchDecision: uncertaintyEngine.researchDecision,
      uncertaintyCriticalReasons: uncertaintyEngine.criticalReasons,
    ...
    productionProbabilityAdjustedByUncertaintyEngine: false,
