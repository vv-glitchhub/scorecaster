...
export async function hydrateAgentDecisionSigningEnvironment(options = {}) {
  ...
  if (existing) {
    process.env.AGENT_DECISION_SIGNING_KEY_SOURCE = process.env.AGENT_DECISION_SIGNING_KEY_SOURCE || "environment";
    return { configured: true, source: process.env.AGENT_DECISION_SIGNING_KEY_SOURCE, secretValueIncluded: false };
  }
