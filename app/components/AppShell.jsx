...
export default function AppShell({ children }) {
  ...
  const secondaryItems = useMemo(() => [
    ...
    { href: "/near-play", label: "Near PLAY" },
    ...
    { href: "/data-readiness", label: tr({ fi: "Datan valmius", en: "Data readiness", es: "Preparación de datos" }) },
  ...
  const operatorItems = useMemo(() => [
    ...
    { href: "/api/data-readiness", label: "Data Readiness API" },
