  ...
  const groups = useMemo(() => [
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/diagnostics", label: tr({ fi: "Päätösdiagnostiikka", en: "Decision diagnostics", es: "Diagnóstico de decisiones" }), description: tr({ fi: "PLAY-, CAUTION- ja SKIP-syyt, datan laatu ja liigakattavuus.", en: "PLAY, CAUTION and SKIP reasons, data quality and league coverage.", es: "Motivos PLAY, CAUTION y SKIP, calidad y cobertura." }) },
