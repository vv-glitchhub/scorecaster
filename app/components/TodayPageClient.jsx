    ...
    <article className="overflow-hidden rounded-[2rem] border border-emerald-400/35 bg-emerald-500/10 shadow-2xl">
      ...
      <div className="p-5 sm:p-6">
        ...
        <div className="mt-5 grid grid-cols-2 gap-3 sm:grid-cols-5">
          ...
          <div className="rounded-2xl bg-[var(--sc-surface-soft)] p-4"><div className="text-[10px] font-bold uppercase text-[var(--sc-faint)]">{tr({ fi: "Varmuus", en: "Confidence", es: "Confianza" })}</div><div className="mt-1 text-xl font-black text-[var(--sc-text)]">{percent(item.confidence)}</div></div>
