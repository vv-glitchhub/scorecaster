...
export default function PrivacyPage() {
  return (
    <PolicyPage
      ...
      intro="Scorecaster is designed to collect the minimum account, verified-watchlist, alert-history, alert-preference and paper-tracking data required to operate the service. It does not process deposits, withdrawals, payment cards, bank accounts or bookmaker credentials."
      sections={[
        {
          title: "Data we process",
          body: [
            "An account may contain an email address, an internal user identifier, optional display name, paper-bankroll settings, paper bets, result tracking, verified watchlist selections, alert thresholds, Alert Inbox preferences, deduplicated alert history and security-relevant timestamps.",
        ...
        },
        {
          ...
          body: [
            "Account data is used for authentication, cross-device synchronization, paper history, risk calculations, verified watchlist comparisons, inbox filtering and acknowledgement, user-requested export and account deletion.",
        ...
        },
        {
          ...
          body: [
            ...
            "Account export and deletion include verified watchlist rows, Alert Inbox settings, visible and dismissed inbox rows. Public release requires a configured support contact and a finalized controller identity. This policy must be reviewed before App Store or Google Play submission."
          ]
        }
      ]}
    />
