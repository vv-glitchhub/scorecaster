...
export async function GET(request) {
  ...
  let [profileResult, betsResult, settlementMonitorResult, bankrollResult, watchlistResult, watchlistMonitorResult, alertInboxResult, timelineResult, preferencesResult, devicesResult, deliveriesResult] = results;
  ...
  for (const result of [settlementMonitorResult, watchlistResult, watchlistMonitorResult, alertInboxResult, timelineResult, preferencesResult, devicesResult, deliveriesResult]) {
  ...
  return jsonResponse({
    ...
    product: "Scorecaster",
    dataClassification: "paper-tracking, automatic settlement metadata, model-audit snapshots, verified watchlist, background monitor metadata, market timeline, alert inbox, notification metadata and account data; no payment data",
