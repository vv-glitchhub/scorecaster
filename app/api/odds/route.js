...
function getGroupFromSportKey(sportKey) {
  ...
  try {
    ...
    if (cached) {
      return buildJson({
        ...
        empty: Boolean(cached.empty),
        quotaExceeded: Boolean(cached.quotaExceeded),
    ...
    const demoData = pickDemoData("icehockey_liiga");
