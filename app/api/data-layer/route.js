...
export async function GET(request) {
  ...
  try {
    ...
    return Response.json({
      ok: true,
      version: "unified-sports-data-api-v9",
      ...
      architecture: {
        ...
        advancedSignalDependencePolicy: "advanced xG models are lineage-derived into the expected-performance family and never share a market vote",
