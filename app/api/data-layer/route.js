...
export async function GET(request) {
  ...
  try {
    ...
    return Response.json({
      ok: true,
      version: "unified-sports-data-api-v8",
      ...
      architecture: {
        ...
        advancedSignalDependencePolicy: "NHL xG/goalie output is lineage-derived into the expected-performance family and never shares a market vote",
      ...
      safety: {
        ...
        nhlAdvancedUsesPostFixtureObservations: false,
        nhlAdvancedUsesMarketProviderData: false,
