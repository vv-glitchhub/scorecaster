...
export default function DashboardPage() {
  return (
    <div className="space-y-6">
      <section className="rounded-3xl border border-white/10 bg-gradient-to-br from-slate-900 to-slate-950 p-8 shadow-2xl">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-lg text-slate-300">
            Betting analytics, market intelligence, simulations and autonomous AI learning agent.
          </p>
        </div>
      </section>
      ...
      <section className="grid gap-4 md:grid-cols-4">
        ...
        <StatCard title="Open Bets" value="3" subtitle="AI monitored picks" />
        <StatCard title="Risk Level" value="Medium" subtitle="Market volatility" />
      </section>
      ...
      <section className="grid gap-6 lg:grid-cols-3">
              ...
              >
                <div className="flex justify-between gap-3">
                  ...
                  <div className="text-right">
                    <div className="font-black text-emerald-300">{pick.edge}</div>
        ...
        <Panel title="AI Agent Notes" subtitle="Learning system preview">
          <div className="space-y-3 text-sm text-slate-300">
            <p>
              Agent is currently in paper betting mode with a 1000€ virtual bankroll.
            </p>
            <p>
              It will track predictions, results, CLV, mistakes and model weaknesses.
            </p>
