...
const modules = [
  {
    ...
    href: "/betting",
    description: "Analyze odds, EV, Kelly, edge and bet slip.",
    tag: "Core"
  },
  {
    title: "Intelligence Terminal",
    href: "/intelligence",
    description: "Research matches, risks, AI thesis and market ideas.",
    tag: "Research"
  },
  {
  ...
  },
  {
    title: "Tracking",
    href: "/tracking",
    description: "Follow bankroll, ROI, CLV and bet history.",
    tag: "Performance"
  },
  {
    title: "AI Agent",
    href: "/agent",
    description: "Paper betting agent with 1000€ virtual bankroll.",
    tag: "Autonomous"
  }
];

const topPicks = [
  { match: "Tappara vs Ilves", pick: "Tappara ML", edge: "+7.4%" },
  { match: "HIFK vs Kärpät", pick: "Under 5.5", edge: "+5.1%" },
  { match: "Rangers vs Bruins", pick: "Bruins ML", edge: "+4.9%" }
];
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard title="Top Edge" value="+7.4%" subtitle="Best model edge today" tone="blue" />
        <StatCard title="Live Signals" value="12" subtitle="Market pulse events" tone="red" />
        <StatCard title="Open Picks" value="3" subtitle="AI monitored picks" />
      </section>
            ...
            <div className="space-y-3">
              {topPicks.map((pick) => (
                ...
                >
                  ...
                  <div className="mt-1 text-sm text-slate-400">{pick.pick}</div>
          ...
          <Panel title="System Status" subtitle="Current mode">
            <div className="space-y-3 text-sm text-slate-300">
              <div className="rounded-xl bg-emerald-400/10 p-4">
                UI foundation active.
              </div>
              <div className="rounded-xl bg-sky-400/10 p-4">
                Analysis, tracking, simulator and agent engines added.
              </div>
              <div className="rounded-xl bg-yellow-400/10 p-4">
                Next: connect real odds data to the new UI.
              </div>
            </div>
          </Panel>
        </div>
